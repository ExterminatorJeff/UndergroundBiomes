...
public class GenLayerUndergroundVoronoiZoom extends GenLayerUnderground
{
    public GenLayerUndergroundVoronoiZoom(long par1, GenLayerUnderground par3GenLayer)
    {
        super(par1);
