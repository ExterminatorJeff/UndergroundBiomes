...
public class GenLayerUndergroundZoom extends GenLayerUnderground
{
    public GenLayerUndergroundZoom(long par1, GenLayerUnderground par3GenLayer)
    {
        super(par1);
    ...
    public static GenLayerUnderground func_75915_a(long par0, GenLayerUnderground par2GenLayer, int par3)
    {
        Object var4 = par2GenLayer;

        for (int var5 = 0; var5 < par3; ++var5)
        {
            var4 = new GenLayerUndergroundZoom(par0 + (long)var5, (GenLayerUnderground)var4);
        }

        return (GenLayerUnderground)var4;
    }
}
